...
#source /lustre/home/elena/PSReliP/rapdb_14gr_all_threads.config (threads: 32; job: 2881554)
#source /lustre/home/elena/PSReliP/rapdb_14gr_all_threads.config (threads: 8; job: 2881551)
#source /lustre/home/elena/PSReliP/rapdb_14gr_threads.config (threads: 32; job: 2881571)
#source /lustre/home/elena/PSReliP/rapdb_14gr_threads.config (threads: 8; job: 2881572)
#source /lustre/home/elena/PSReliP/rapdb_5cl_threads.config (threads: 32; job: 2881575)
#source /lustre/home/elena/PSReliP/rapdb_5cl_threads.config (threads: 8; job: 2881588)
#source /lustre/home/elena/PSReliP/rapdb_5gr_all_threads.config (threads: 32; job: 2881591)
#source /lustre/home/elena/PSReliP/rapdb_5gr_all_threads.configi (threads: 8; job: 2881996)
#source /lustre/home/elena/PSReliP/rapdb_5gr_threads.config (threads: 32; job: 2882004)
#source /lustre/home/elena/PSReliP/rapdb_5gr_threads.config (threads: 8; job: 2882006)
...
then
  ...
  "${PLINK2_DEV_HOME}"/plink2 --pfile "${INPUT_DIR}"/"${OUTPUT_PREFIX}"_ld"${LD_THRESHOLD}"_pl2_b --allow-extra-chr --het 'cols=+het,+het' --memory "$MAX_MEM_USAGE" --threads 8 --out "${BS_OUTPUT_DIR}"/"${OUTPUT_PREFIX}"_het
  ...
  then
    ...
    "${PLINK2_DEV_HOME}"/plink2 --pfile "${INPUT_DIR}"/"${OUTPUT_PREFIX}"_ld"${LD_THRESHOLD}"_pl2_b --allow-extra-chr --fst CATEGORY 'report-variants' --pheno "${INPUT_DIR}"/"${OUTPUT_PREFIX}"_groups.list --memory "$MAX_MEM_USAGE" --threads 8 --out "${FST_OUTPUT_DIR}"/"${OUTPUT_PREFIX}"_ld"${LD_THRESHOLD}"_fst
    ...
    "${PLINK2_DEV_HOME}"/plink2 --pfile "${INPUT_DIR}"/"${OUTPUT_PREFIX}"_ld"${LD_THRESHOLD}"_pl2_b --allow-extra-chr --fst CATEGORY --pheno "${INPUT_DIR}"/"${OUTPUT_PREFIX}"_groups.list --memory "$MAX_MEM_USAGE" --threads 8 --out "${FST_OUTPUT_DIR}"/"${OUTPUT_PREFIX}"_ld"${LD_THRESHOLD}"_fst
    perl "${PERL_PROGRAM_HOME}"/ps_columns_names_edit.pl "${FST_OUTPUT_DIR}"/"${OUTPUT_PREFIX}"_ld"${LD_THRESHOLD}"_fst.fst.summary "${SHINY_APP_DIR}"/"${OUTPUT_PREFIX}"/data/plink_fst.fst.summary
    perl "${PERL_PROGRAM_HOME}"/ps_fst_summary_edit.pl "${FST_OUTPUT_DIR}"/"${OUTPUT_PREFIX}"_ld"${LD_THRESHOLD}"_fst.fst.summary "${INPUT_DIR}"/"${OUTPUT_PREFIX}"_groups_names_numbers.list "${SHINY_APP_DIR}"/"${OUTPUT_PREFIX}"/data/results_data.fst.summary
  fi
  ...
  then
    ...
    "${PLINK2_DEV_HOME}"/plink2 --pfile "${INPUT_DIR}"/"${OUTPUT_PREFIX}"_ld"${LD_THRESHOLD}"_pl2_b --allow-extra-chr --read-freq "${ALLELE_FREQ_COUNTS_FILE}" --make-rel meanimpute square --memory "$MAX_MEM_USAGE" --threads 8 --out "${KSH_OUTPUT_DIR}"/"${OUTPUT_PREFIX}"_pl2_ld"${LD_THRESHOLD}"_grm
    ...
    "${PLINK2_DEV_HOME}"/plink2 --pfile "${INPUT_DIR}"/"${OUTPUT_PREFIX}"_ld"${LD_THRESHOLD}"_pl2_b --allow-extra-chr --read-freq "${ALLELE_FREQ_COUNTS_FILE}" --make-rel square --memory "$MAX_MEM_USAGE" --threads 8 --out "${KSH_OUTPUT_DIR}"/"${OUTPUT_PREFIX}"_pl2_ld"${LD_THRESHOLD}"_grm
  ...
  then
    ...
    "${PLINK2_DEV_HOME}"/plink2 --pfile "${INPUT_DIR}"/"${OUTPUT_PREFIX}"_pl2_b --allow-extra-chr --fst CATEGORY 'report-variants' --pheno "${INPUT_DIR}"/"${OUTPUT_PREFIX}"_groups.list --memory "$MAX_MEM_USAGE" --threads 8 --out "${FST_OUTPUT_DIR}"/"${OUTPUT_PREFIX}"_fst
    ...
    "${PLINK2_DEV_HOME}"/plink2 --pfile "${INPUT_DIR}"/"${OUTPUT_PREFIX}"_pl2_b --allow-extra-chr --fst CATEGORY --pheno "${INPUT_DIR}"/"${OUTPUT_PREFIX}"_groups.list --memory "$MAX_MEM_USAGE" --threads 8 --out "${FST_OUTPUT_DIR}"/"${OUTPUT_PREFIX}"_fst
    perl "${PERL_PROGRAM_HOME}"/ps_columns_names_edit.pl "${FST_OUTPUT_DIR}"/"${OUTPUT_PREFIX}"_fst.fst.summary "${SHINY_APP_DIR}"/"${OUTPUT_PREFIX}"/data/plink_fst.fst.summary
    perl "${PERL_PROGRAM_HOME}"/ps_fst_summary_edit.pl "${FST_OUTPUT_DIR}"/"${OUTPUT_PREFIX}"_fst.fst.summary "${INPUT_DIR}"/"${OUTPUT_PREFIX}"_groups_names_numbers.list "${SHINY_APP_DIR}"/"${OUTPUT_PREFIX}"/data/results_data.fst.summary
  fi
  ...
  then
    ...
    "${PLINK2_DEV_HOME}"/plink2 --pfile "${INPUT_DIR}"/"${OUTPUT_PREFIX}"_pl2_b --allow-extra-chr --read-freq "${ALLELE_FREQ_COUNTS_FILE}" --make-rel meanimpute square --memory "$MAX_MEM_USAGE" --threads 8 --out "${KSH_OUTPUT_DIR}"/"${OUTPUT_PREFIX}"_pl2_grm
    ...
    "${PLINK2_DEV_HOME}"/plink2 --pfile "${INPUT_DIR}"/"${OUTPUT_PREFIX}"_pl2_b --allow-extra-chr --read-freq "${ALLELE_FREQ_COUNTS_FILE}" --make-rel square --memory "$MAX_MEM_USAGE" --threads 8 --out "${KSH_OUTPUT_DIR}"/"${OUTPUT_PREFIX}"_pl2_grm
